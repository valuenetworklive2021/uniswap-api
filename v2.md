...
## [`/v2/summary`](https://api.valueswap.valuenetwork.live/v2/summary)
...
`GET https://api.valueswap.valuenetwork.live/v2/summary`
...
## [`/v2/assets`](https://api.valueswap.valuenetwork.live/v2/assets)
...
`GET https://api.valueswap.valuenetwork.live/v2/assets`
...
## [`/v2/tickers`](https://api.valueswap.valuenetwork.live/v2/tickers)
...
`GET https://api.valueswap.valuenetwork.live/v2/tickers`
...
`GET https://api.valueswap.valuenetwork.live/v2/orderbook/:pair`
...
`GET https://api.valueswap.valuenetwork.live/v2/trades/:pair`
